...
//      if(eregi('^(.+):([0-9]+)$', $hosts[$index], $hostinfo)) {
      ...
      if($this->smtp->Connect(($ssl ? 'ssl://':'').$host, $port, $this->Timeout)) {
		...
		// this->smtp->IsTLS checks the reply from the HELO command and see if STARTTLS is required by the server
		// This is used to auto detect TLS from smtp.gmail.com
		// This only works with a customized version of class.smtp.php
		// Added by PERSONY, INC. www.persony.com 2010-06-02
		if($tls || $this->smtp->IsTLS()) {
